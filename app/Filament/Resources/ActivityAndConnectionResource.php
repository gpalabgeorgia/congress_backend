...
use App\Filament\Resources\ActivityAndConnectionResource\Pages;
...
class ActivityAndConnectionResource extends Resource
{
    protected static ?string $model = ActivityAndConnection::class;

    protected static ?string $navigationIcon = 'heroicon-o-link';
    protected static ?string $navigationGroup = 'ჩვენს შესახებ';
    protected static ?string $navigationLabel = 'მოღვაწეობა და კავშირები';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('ტექსტები (ენების მიხედვით)')
                    ->schema([
                        Forms\Components\Tabs::make('ActivityLanguages')
                            ->tabs($langTabs),
                    ]),
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ListActivityAndConnections::route('/'),
            'create' => Pages\CreateActivityAndConnection::route('/create'),
            'edit' => Pages\EditActivityAndConnection::route('/{record}/edit'),
        ];
    }
}
